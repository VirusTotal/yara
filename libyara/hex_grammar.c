...
{
       0,   106,   106,   115,   119,   131,   142,   151,   160,   164,
     173,   178,   177,   190,   226,   258,   280,   300,   304,   321,
     330,   339
};
#endif
...
{
  "$end", "error", "$undefined", "_BYTE_", "_MASKED_BYTE_", "_NOT_BYTE_",
  "_NUMBER_", "'{'", "'}'", "'('", "')'", "'['", "']'", "'-'", "'|'",
  "$accept", "hex_string", "tokens", "token_sequence", "token_or_range",
  "token", "$@1", "range", "alternatives", "byte", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,   123,   125,    40,
      41,    91,    93,    45,   124
};
# endif
...
{
       1,    12,    11,   -12,   -12,   -12,   -12,    18,    -2,   -12,
     -12,    12,   -12,    -1,    -2,   -12,    -4,   -12,   -12,    13,
      17,    19,   -12,    10,   -12,    12,   -12,     7,   -12,   -12,
      20,   -12,   -12
};
...
{
       0,     0,     0,    19,    21,    20,    11,     0,     3,    10,
       1,     0,     2,     0,     0,     6,     8,     9,    17,     0,
       0,     0,     7,     8,    12,     0,    13,     0,    16,    18,
       0,    15,    14
};
...
{
     -12,   -12,   -11,   -12,    21,    14,   -12,   -12,   -12,   -12
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     7,    14,    15,     8,    11,    17,    19,     9
};
...
{
      18,     3,     4,     5,    -4,    20,    -4,     6,     1,    13,
      -4,    10,    21,    30,    29,     3,     4,     5,    -5,    31,
      -5,     6,    16,    24,    -5,     0,    12,    25,    23,    26,
      27,    28,    32,     0,     0,    22
};

static const yytype_int8 yycheck[] =
{
      11,     3,     4,     5,     8,     6,    10,     9,     7,    11,
      14,     0,    13,     6,    25,     3,     4,     5,     8,    12,
      10,     9,     8,    10,    14,    -1,     8,    14,    14,    12,
      13,    12,    12,    -1,    -1,    14
};
...
{
       0,     7,    16,     3,     4,     5,     9,    17,    20,    24,
       0,    21,     8,    11,    18,    19,    20,    22,    17,    23,
       6,    13,    19,    20,    10,    14,    12,    13,    12,    17,
       6,    12,    12
};
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, void *yyscanner, HEX_LEX_ENVIRONMENT *lex_env)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yyscanner);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, void *yyscanner, HEX_LEX_ENVIRONMENT *lex_env)
{
  YYFPRINTF (yyo, "%s %s (",
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, void *yyscanner, HEX_LEX_ENVIRONMENT *lex_env)
{
...
#line 1113 "hex_grammar.c"
        break;

    case 18: /* token_sequence  */
#line 96 "hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 1119 "hex_grammar.c"
        break;

    case 19: /* token_or_range  */
#line 97 "hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 1125 "hex_grammar.c"
        break;

    case 20: /* token  */
#line 98 "hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 1131 "hex_grammar.c"
        break;

    case 22: /* range  */
#line 101 "hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 1137 "hex_grammar.c"
        break;

    case 23: /* alternatives  */
#line 100 "hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 1143 "hex_grammar.c"
        break;

    case 24: /* byte  */
#line 99 "hex_grammar.y"
            { yr_re_node_destroy(((*yyvaluep).re_node)); ((*yyvaluep).re_node) = NULL; }
#line 1149 "hex_grammar.c"
        break;
...
#line 1483 "hex_grammar.c"
    break;

  case 8:
#line 161 "hex_grammar.y"
      {
        (yyval.re_node) = (yyvsp[0].re_node);
      }
#line 1491 "hex_grammar.c"
    break;
...
#line 1516 "hex_grammar.c"
    break;

  case 12:
#line 182 "hex_grammar.y"
      {
        (yyval.re_node) = (yyvsp[-1].re_node);
        lex_env->inside_or--;
      }
...
#line 1655 "hex_grammar.c"
    break;

  case 18:
#line 305 "hex_grammar.y"
      {
...
#line 1673 "hex_grammar.c"
    break;

  case 19:
#line 322 "hex_grammar.y"
      {
...
#line 1686 "hex_grammar.c"
    break;

  case 20:
#line 331 "hex_grammar.y"
      {
...
#line 1699 "hex_grammar.c"
    break;

  case 21:
#line 340 "hex_grammar.y"
      {
...
#line 1726 "hex_grammar.c"
    break;


#line 1730 "hex_grammar.c"
