...
am_yara_OBJECTS = yara.$(OBJEXT)
yara_OBJECTS = $(am_yara_OBJECTS)
yara_DEPENDENCIES = libyara/.libs/libyara.a
DEFAULT_INCLUDES = -I.
...
yara$(EXEEXT): $(yara_OBJECTS) $(yara_DEPENDENCIES) 
	@rm -f yara$(EXEEXT)
	$(LINK) $(yara_OBJECTS) $(yara_LDADD) $(LIBS)
